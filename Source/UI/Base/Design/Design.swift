...
public struct Design {
    ...
    public enum Font {
        ...
        public var value: UIFont {
            switch self {
            case let .regular(size): return UIFont.systemFont(ofSize: size, weight: .regular)
            case let .heavy(size):   return UIFont.systemFont(ofSize: size, weight: .heavy)
            case let .light(size):   return UIFont.systemFont(ofSize: size, weight: .light)
            }
        }
    }
    
    public static func attributedString(from string: String, font: UIFont, spacing: CGFloat) -> NSMutableAttributedString {
    ...
    public static func attributedString(from string: String, font: UIFont, interlineage: CGFloat) -> NSMutableAttributedString {
